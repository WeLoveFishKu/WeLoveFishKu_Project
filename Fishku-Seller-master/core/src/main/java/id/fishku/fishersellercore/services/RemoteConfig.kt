package id.fishku.fishersellercore.services
...
class RemoteConfig @Inject constructor(
    ...
    companion object{
        const val KEY_VERSION = "update_version_seller_app"
        const val URI_APP = "market://details?id=id.fishku.fisherseller"
    }
        ...
        remoteConfig.apply {
            ...
            fetchAndActivate().addOnCompleteListener { task ->
                ...
                if (task.isSuccessful) {
                    ...
                    Timber.tag("TAG").d(update.toString())
                } else {
                    Timber.tag("TAG").d(" %s", updated)
                }
            }
        }
