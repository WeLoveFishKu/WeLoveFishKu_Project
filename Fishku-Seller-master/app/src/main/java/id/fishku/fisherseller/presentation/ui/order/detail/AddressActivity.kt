...
import id.fishku.fisherseller.databinding.ActivityAddressBinding
import id.fishku.fishersellercore.core.showMessage
...
class AddressActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    companion object {
        const val EXTRA_ADDRESS =
            "id.fishku.fisherseller.presentation.ui.order.detail.EXTRA_ADDRESS"
        const val EXTRA_LONGITUDE =
            "id.fishku.fisherseller.presentation.ui.order.detail.EXTRA_LONGITUDE"
        const val EXTRA_LATITUDE =
            "id.fishku.fisherseller.presentation.ui.order.detail.EXTRA_LATITUDE"
    }
}