...
models: Dict = {
    'bandeng': 'Bandeng_FishGills.h5',
    'tongkol': 'tongkol_insang.h5',
    'kembung': 'kembung_insang.h5'
}


def predict_result(img: Image, model_h5: Union[Dict, str]= 'Bandeng_FishGills.h5') -> str:
    """
    params:
